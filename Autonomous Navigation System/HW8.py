'''
An autonomous navigation system into a quadcopter
Implementation of: 
    - extended Kalman filter for data fusion and state estimation
    - PID controller to generate steering commands. 
'''
